...
write.table((class_df %>% filter(class == 'uniq_02', direct_02 == 'up'))$Associated.Gene.Name,
            '../processed_data/degenes/02_up.csv',
            quote = F, col.names = F, row.names = F)

# DE exclusively between 02, down
write.table((class_df %>% filter(class == 'uniq_02', direct_02 == 'down'))$Associated.Gene.Name,
            '../processed_data/degenes/02_down.csv',
            quote = F, col.names = F, row.names = F)

# DE exclusively between 28, up
write.table((class_df %>% filter(class == 'uniq_28', direct_02 == 'up'))$Associated.Gene.Name,
            '../processed_data/degenes/28_up.csv',
            quote = F, col.names = F, row.names = F)

# DE exclusively between 28, down
write.table((class_df %>% filter(class == 'uniq_28', direct_02 == 'down'))$Associated.Gene.Name,
            '../processed_data/degenes/28_down.csv',
            quote = F, col.names = F, row.names = F)

# DE between 02 and 28, up
write.table((class_df %>% filter(class == 'both', direct_02 == 'up'))$Associated.Gene.Name,
            '../processed_data/degenes/02_and_28_up.csv',
            quote = F, col.names = F, row.names = F)

# DE between 02 and 28, down
write.table((class_df %>% filter(class == 'both', direct_02 == 'down'))$Associated.Gene.Name,
            '../processed_data/degenes/02_and_28_down.csv',
            quote = F, col.names = F, row.names = F)
```

```{r}
# KEGG pathway enrichment
class_df %>% filter(class == 'uniq_02', direct_02 == 'down')
```
