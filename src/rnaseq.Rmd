...
ggsave('../supp_figs/Volcano/0vs2.pdf', height = 8.5, width = 6.5)
ggsave('../main_figs/Fig3C.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/0vs4.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/0vs6.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/0vs8.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/2vs4.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/2vs6.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/2vs8.pdf', height = 8.5, width = 6.5)
ggsave('../main_figs/Fig3D.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/4vs6.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/4vs8.pdf', height = 8.5, width = 6.5)
...
ggsave('../supp_figs/Volcano/6vs8.pdf', height = 8.5, width = 6.5)
```
...
if(FALSE) {
  ...
  fpkm_dds <- fpkm(dds)
  write.table(fpkm_dds, '../processed_data/data_tables/RNA-seq-FPKM.txt')
}

fpkm_dds = read.table('../processed_data/data_tables/RNA-seq-FPKM.txt', header = TRUE, check.names = FALSE)
...
all_genes <- as.data.frame(fpkm_dds) %>% 
  ...
  t() %>% as.data.frame()
write.csv(all_genes, '../processed_data/data_tables/RNA-seq-FPKM-with-gene-names.csv')
```
...
both = all_genes %>% dplyr::select(filter(class_df, class == 'both')$Associated.Gene.Name) %>%
  tibble::rownames_to_column(var = "sample_ID") %>% 
  separate(col = 'sample_ID', into = c("exp", "index", "condition"), sep = "_", remove = F) %>% dplyr::select(-exp, -index)
write.csv(both, '../processed_data/gene_lists/02_and_28_list.csv', quote = F)
write.table(filter(class_df, class == 'both')$Associated.Gene.Name, '../processed_data/gene_lists/02_and_28_genes.txt', quote = F, row.names = F, col.names = F)

uniq_02 = all_genes %>% dplyr::select(filter(class_df, class == 'uniq_02')$Associated.Gene.Name) %>%
  tibble::rownames_to_column(var = "sample_ID") %>% 
  separate(col = 'sample_ID', into = c("exp", "index", "condition"), sep = "_", remove = F) %>% dplyr::select(-exp, -index)
write.csv(uniq_02, '../processed_data/gene_lists/02_list.csv', quote = F)
write.table(filter(class_df, class == 'uniq_02')$Associated.Gene.Name, '../processed_data/gene_lists/02_genes.txt', quote = F, row.names = F, col.names = F)

uniq_28 = all_genes %>% dplyr::select(filter(class_df, class == 'uniq_28')$Associated.Gene.Name) %>%
  tibble::rownames_to_column(var = "sample_ID") %>% 
  separate(col = 'sample_ID', into = c("exp", "index", "condition"), sep = "_", remove = F) %>% dplyr::select(-exp, -index)
write.csv(uniq_28, '../processed_data/gene_lists/28_list.csv', quote = F)
write.table(filter(class_df, class == 'uniq_28')$Associated.Gene.Name, '../processed_data/gene_lists/28_genes.txt', quote = F, row.names = F, col.names = F)
```
