...
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 60), title = 'CHOW versus WD2', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/0vs2.pdf', height = 8, width = 6.5)

# 4 vs 0
res = lfcShrink(dds, contrast = c("condition", "4","0"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 40), title = 'CHOW versus WD4', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/0vs4.pdf', height = 8, width = 6.5)

# 6 vs 0
res = lfcShrink(dds, contrast = c("condition", "6","0"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 55), title = 'CHOW versus WD6', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/0vs6.pdf', height = 8, width = 6.5)

# 8 vs 0
res = lfcShrink(dds, contrast = c("condition", "8","0"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 55), title = 'CHOW versus WD8', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/0vs8.pdf', height = 8, width = 6.5)

# 4 vs. 2
res = lfcShrink(dds, contrast = c("condition", "4","2"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 7.5), title = 'WD2 versus WD4', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/2vs4.pdf', height = 8, width = 6.5)

# 6 vs. 2
res = lfcShrink(dds, contrast = c("condition", "6","2"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 10), title = 'WD2 versus WD6', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/2vs6.pdf', height = 8, width = 6.5)

# 8 vs. 2
res = lfcShrink(dds, contrast = c("condition", "8","2"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 12.5), title = 'WD2 versus WD8', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/2vs8.pdf', height = 8, width = 6.5)

# 6 vs. 4
res = lfcShrink(dds, contrast = c("condition", "6","4"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 5), title = 'WD4 versus WD6', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/4vs6.pdf', height = 8, width = 6.5)

# 8 vs. 4
res = lfcShrink(dds, contrast = c("condition", "8","4"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 5), title = 'WD4 versus WD8', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
ggsave('../figures/volcano/4vs8.pdf', height = 8, width = 6.5)

# 8 vs. 6
res = lfcShrink(dds, contrast = c("condition", "8","6"), type = 'ashr')
annotation = data.frame("Ensembl.Gene.ID" = rownames(res), stringsAsFactors = FALSE) %>% left_join(., mapping, by = "Ensembl.Gene.ID")
EnhancedVolcano(res, lab = annotation$Associated.Gene.Name, x = 'log2FoldChange', y = 'padj', ylim = c(0, 3), title = 'WD6 versus WD8', pCutoff = 0.05, FCcutoff = 0.5, colAlpha = 0.5, pointSize = 2.0)
...
a <- summary_df %>% ggplot(aes(x = t1, y = t2)) + geom_tile(aes(fill = Total), color = 'black', size = 0.5, alpha = 0.9) +
...
b <- summary_df %>% ggplot(aes(x = t1, y = t2)) + geom_tile(aes(fill = Up), color = 'black', size = 0.5, alpha = 0.9) +
...
c <- summary_df %>% ggplot(aes(x = t1, y = t2)) + geom_tile(aes(fill = Down), color = 'black', size = 0.5, alpha = 0.9) +
...
ggsave('../figures/rnaseq_pairwise_de_genes_heatmap_fccutoff.pdf', height = 5, width = 13)
rm(a,b,c)
```

```{r}
# The RNA-seq profiles have a largely bi-phasic response. We can categorize genes accordingly.
class_df = class_df %>% 
...
# up? 472
nrow(only_02 %>% filter(Direct_02 == "up"))
  
# down? 171
nrow(only_02 %>% filter(Direct_02 == "down"))
...
```{r}
all_genes %>% 
  dplyr::select(Treatment, Hmgcr, Cidea, Enho, Hal, Cd36) %>%
