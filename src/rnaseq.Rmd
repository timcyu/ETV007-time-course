...
genes02 = as.data.frame(res02) %>% 
  ...
  mutate(
    ...
    DE_02 = ifelse(padj < 0.05 & log2FoldChange > 0.5, "yes", "no"),
...
genes28 = as.data.frame(res28) %>% 
  ...
  mutate(
    ...
    DE_28 = ifelse(padj < 0.05 & log2FoldChange > 0.5, "yes", "no"),
