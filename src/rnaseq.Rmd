...
a <- summary_df %>% 
  ...
  geom_tile(fill='white', color='black', size=0.5, alpha = 0.9) + 
...
plot_kegg(kegg_02_up, 'kegg_02_up', height=4, width=8, color='blue')
plot_kegg(kegg_02_down, 'kegg_02_down', height=4, width=8, color='red')
plot_kegg(kegg_28_up, 'kegg_28_up', height=5, width=8, color='blue')
plot_kegg(kegg_28_down, 'kegg_28_down', height=2, width=8, color='red')
