...
```{r}
autoplot(prcomp(liverData[-c(1,2)], scale. = TRUE), data = liverData, colour = 'Treatment', 
...
autoplot(prcomp(liverData[-c(1,2)], scale. = TRUE), data = liverData, colour = 'Treatment', size = 2.5) + scale_color_manual(values = c('black', '#3b9bb3', '#75af4f', '#e39225', '#c13b41'))
```
```{r}
# Generate dataframe for liver lipidomics bubble plot
totalLipidByClass = liverData %>%
